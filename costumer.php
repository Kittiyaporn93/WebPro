...
<body>
    ...
    echo'<tr><td align="left"><a href="Web1.php">เพิ่มข้อมูลลูกค้า</a></td><tr>';
    ...
    while ($rs = mysqli_fetch_array($result))
    {
        ...
        echo '<td><a href="customerUpdate.php?id=' . $rs["customerID"] . '"> [แก้ไข] </a></td>';
        echo '<td><a href="customerDelete.php?id=' . $rs["customerID"] . '" onclick="return confirm(\'Confirm Delete Customer Id ' . $rs["customerID"] . '\')"> [ลบ] </a></td>';
        echo '</tr>';
    }
